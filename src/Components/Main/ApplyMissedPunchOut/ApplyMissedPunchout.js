...
const ApplyMissedPunchOut = ({ navigation }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await axios.post(
        `${API_BASE_URL}/api/v1/missedPunchOut/create-missedPunchOut`,
        missedPunchOutData,
        {
          headers: {
  ...
  return (
    <>
      ...
      <View style={styles.header}>
        ...
        />
        <Text style={styles.headerTitle}>Apply Missed Punch out</Text>
      </View>
      ...
      <View style={styles.container}>
        ...
        <Text style={{ marginBottom: 5, color: "#555" }}>
          Punch Out Time <Text style={{ color: "red" }}>*</Text>
        </Text>
        {/* Time Picker */}
        <TouchableOpacity
          style={[styles.input, styles.dateInput]}
...
export default ApplyMissedPunchOut;
